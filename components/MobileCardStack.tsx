...
export const MobileCardStack: React.FC<MobileCardStackProps> = ({
  ...
  const cardOffset = isTopic ? 0 : 8;
  const maxCards = 8;
  const fixedHeight = isTopic
    ? "100px"
    : `${(maxCards - 1) * cardOffset + 100}px`;
      ...
      >
        <div
          style={{
            ...
            border: isTopic ? "1px solid #096334" : "1px dashed #ccc",
            backgroundColor: isTopic ? "#096334" : "rgba(255, 255, 255, 0.1)",
            borderRadius: "4px",
          }}
        >
          {isTopic ? (
        ...
        return (
          ...
          >
            ...
            {!isTopic && !shouldShowFaceUp && flippingCard !== card && (
              <Image
                style={{ marginLeft: "4px", marginTop: "3.5px" }}
                draggable={false}
                src="/cardBack.png"
                alt="Card Back"
                width={60}
